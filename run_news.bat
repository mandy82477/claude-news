@echo off
cd /d "C:\Users\Mandy\CLAUDE_OBSIDIAN\ObsidianLab\CLAUDE_NEWS"
...
"C:\Users\Mandy\AppData\Local\Programs\Python\Python313\python.exe" -m news_aggregator.main >> "C:\Users\Mandy\CLAUDE_OBSIDIAN\ObsidianLab\CLAUDE_NEWS\logs\task_scheduler.log" 2>&1
