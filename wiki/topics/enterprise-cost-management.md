...
> **最新成本信任衝擊**（2026-07-13）
> Tech Times 報導 Anthropic 證實一筆 **1660 萬美元帳務錯誤**，稽核人員另發現企業客戶被多收 **170 萬美元**——是本頁追蹤以來首度由官方證實、金額規模最大的企業計費事故，且恰發生在企業支出控管（Spend Controls，07-04 上線）推出後一週餘，對該功能的信任建構效果構成直接對比壓力（推論）。計費事件細節與歷史脈絡見 [[entities/pricing]]；Spend Controls 與四項缺口的對照見下方「缺口 vs 官方對應」表。
