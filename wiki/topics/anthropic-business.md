...
> **這家公司沒有公開財報。** 下表每一列的最後兩欄告訴你這個數字是誰說的、下一次會有新數字的時點。**五種數字量級不同，不可互相替代或加總**——年化營收、單季營收、官方估值、IPO 估值預期、市場總量各答各的問題。
...
| 算力交易總額（11 個月） | The Information 統計口徑，累計談成的算力／雲端合約總額 | $5,170 億（統計期至 2026-09，2026-09-06 報導） | 一級媒體 | 無時點 |
...
- **2026-08-23 Damodaran 營收門檻**：Yahoo Finance 引述知名估值學者 Aswath Damodaran（人稱「Dean of Valuation」，紐約大學史登商學院教授）指出：Anthropic 須有 1.2 兆美元營收才能撐得起市場傳聞的 2 兆美元估值。首見具名獨立估值學者以「營收門檻」形式對 2 兆美元估值提出量化質疑，區別於既有多為媒體/投資人臆測或推崇性報導（如 08-13 PYMNTS/FT/WSJ、08-20 SpaceX 規模對照）；與 08-15 Reuters 獨家「估值繫於 2028 年 1,900–2,000 億美元營收預測」並置時，1.2 兆美元營收門檻與 2028 年營收預測之間存在數量級落差，凸顯若市場真以 2 兆美元估值定價，隱含的營收成長假設遠超既有第三方預測（推論）；具體計算方法論未見報導。
...
- 已查證（2026-09-20，Reuters 電文經 Investing.com／Yahoo Finance 全文轉載確認）｜**2028 年營收預測 1,900–2,000 億美元**：Reuters 引兩位知情人士稱，銀行家據此做企業價值倍數估算，非依當前 ARR。
- 內容與本頁既有引述一致，無新增或矛盾；具體預測方法論、假設前提 Reuters 原文仍未載，屬公司內部推估轉述、非官方公告數字。
...
- **2026-08-15 泡沫討論評論**：Forbes 評論文章：以 Anthropic 估值達 2 兆美元為切入點，討論 AI 是否進入泡沫區間。屬評論文章，非事實揭露或官方數字——作者以坊間流傳的 2 兆美元估值數字（延續 08-13 PYMNTS／FT／WSJ 的報導）為引子，展開對整體 AI 產業是否進入泡沫的分析性討論，與同日既有 Steve Eisman 唱空言論（見「還沒過去的風險」表）同屬市場觀感／評論類訊號，非新增估值數字或公司動作。
- **2026-08-14 CFO 投資人會議**：CNBC（雙重來源確認）報導 CFO Krishna Rao 已展開早期 IPO 相關投資人會議。消息來源為知情人士，報導明確指出尚未討論估值——與同日 Gizmodo「投資人評估估值上看 2 兆美元」報導並置時，顯示公司內部籌備動作與外部市場估值臆測可能各自獨立推進、尚未收斂至同一數字（推論）；延續 07-15 的「銀行家協調投資人會議」信號，本次首次點名主導人為 CFO 本人；具體會議對象、議程細節未見報導。
...
- **2026-08-13 2 兆美元估值三方同日報導**：PYMNTS、Financial Times（雙重來源確認）、WSJ 同日報導 Anthropic 評估上看 2 兆美元估值、規劃創紀錄 IPO。首見具體「2 兆美元」估值數字（此前多為「創紀錄」等定性描述，或 07-09 次級市場 $1.2 兆美元估值屬不同性質數字），且三家獨立財經媒體同日報導，訊號密集度高；WSJ 標題另指出 Anthropic 正設法穩固投資人信心，與既有「敘事整備」（07-17）、「投資人會議」（07-15）等籌備動作系列信號一致（推論）；三則均僅標題可用，具體 IPO 時程、承銷細節、確切估值區間未見報導。
...
| OpenAI Q2 業績落後 Anthropic（多來源，含相反訊號）| WSJ/CoinDesk/SiliconANGLE 稱落後；同期 The Information 稱 OpenRouter 占比回升（相反）| Hacker News/WSJ 等，2026-08-18～19 | 一級媒體 |
| TechRadar：「AI 界的 Apple」定價最高卻拿下最多營收 | Vercel 統計：2026 年 7 月 token 營收份額業界最高 | Google News/TechRadar，2026-08-15；HN，2026-08-17 | 第三方研究 |
| Raleigh 合資企業招聘，最高職缺薪資逾 **60 萬美元** | Business Journals 報導 Anthropic 旗下合資企業招聘 | Google News/The Business Journals，2026-08-15 | 一級媒體 |
| Nvidia 對 Anthropic 等公司合計約 700 億美元投資 | Yahoo Finance 分析潛在股東回報，非新增融資事件 | Google News/finance.yahoo.com，2026-08-12 | 第三方研究 |
| OpenAI／Anthropic 合計佔「AI 產業」營收 70%（已查證，範圍窄於原題）⟨Q-01⟩ | 分析師 Ed Zitron 主張兩家佔三大雲端商 AI 營收 70%；HN 討論反駁（73 分） | Hacker News（YouTube 轉貼），2026-08-09；查證 2026-09-20 | 分析師估算引第三方研究（非 Anthropic 官方數字） |
| Economic Futures Research Fund：承諾 2 億美元支持外部研究 | 聚焦勞工衝擊、AI 轉型輔助、所得支持現代化等五大方向 | Anthropic Blog，2026-07-23 | 官方一手 |
| 著作權和解案再添細節：哈利波特出版商獲數百萬美元賠付 | The Guardian 等六媒體跟進和解案後續報導 | The Guardian 等六媒體，2026-07-22～25 | 一級媒體 |
| 訂閱補貼社群估算 13–40 倍 | 三個方法論（token-xray／modelplane.ai／Quesma）指向同一量級，最新 2026-09-06；同數值見「現在的數字」表 | 社群計算，2026-05-28～09-06 | 社群估算 |
| $30,983 tokens on $200/mo | 重度用戶單月在 Max 方案下消耗相當 $30,983 計算資源 | tokenflex.ing 排行榜，2026-05-23 | 社群估算 |
| 定價強勢期 | 企業客戶即使面對成本上漲仍持續採用 | The Information，2026-05-13 | 一級媒體 |
| 3Q26 獲利 > $10 億美元 | 首度被第三方揭露正獲利數據，IPO 財務前瞻指標 | SemiAnalysis，2026-07-08 | 第三方研究 |
| 著作權集體訴訟 15 億美元和解獲法院核准 | 美國法官正式核准，Engadget 稱「創紀錄」和解金額 | Reuters，2026-07-20 | 一級媒體 |
| 著作權和解案執行細節：91% 賠付申請率、律師費 6.8%、Bloomsbury 分潤 | 逾 48.2 萬本受涵蓋書籍，每本約 3,000 美元 | Reuters、The Times、Research Information，2026-07-22 | 一級媒體 |
| 著作權和解案讀者反應報導（非新增賠付事實）| NPR：作家群體對和解案反應不一 | NPR，2026-07-27 | 一級媒體 |
| 未公開獲利時程 | Anthropic 從未公告盈虧平衡預期完整細節 | — | — |
| 「Anthropic Tops $47B」報導；已查證，非新增長數字 | 同一 5 月里程碑媒體重提，查證後未見更高數字 | Google News/tech-insider.org，2026-08-03；2026-08-13 查證 | 一級媒體 |

**`⟨Q-nn⟩` 是這一格還沒查實的地方，完整說明在表下細節區同編號那一條。**

%% 維運備忘：累積封頂 20 列，滿了汰除來源日期最舊者，被汰者留在細節區；已在「現在的數字」表有列的指標本表不重複寫數值，只留來源與等級（訂閱補貼倍數列已改）。 %%
...
- ⟨Q-01⟩ 已查證（2026-09-20）｜**「70%」指三大雲端商 AI 營收，非整體 AI 產業**：源自分析師 Ed Zitron 推算——OpenAI＋Anthropic 佔 Microsoft／Google／Amazon 三家雲端商 AI 營收逾 70%，非「整個 AI 產業」。
- 分項：Microsoft FY26 來自 OpenAI 營收 $241 億（≈其 AI 銷售 70%）；Barclays 估兩家佔 AWS AI 營收今年 13%；UBS 估佔 Google Cloud 今年 27%，三者加總落在 70% 量級。
- 惟衡量範圍是雲端商 AI 業務，非產業整體，原標題未言明；HN 反駁聲音仍為未附來源臆測；與本頁「企業採用率」43.5%（衡量家數）為不同維度，不可混用。
...
**結構性問題**：訂閱方案補貼規模龐大（社群估算 13–40 倍），6/15 政策是 Anthropic 收窄補貼的第一步。社群討論「未來必然漲價」但 Anthropic 無官方回應。
...
**不在本表的三類，去哪裡看：**
- **計費事故與靜默計費改動** → [[entities/pricing]]「事故現在還在發生嗎」（那張表每一案都標明現在還在不在）
...
%% 維運備忘：衝擊表退場本輪跑一遍——六列差異全部現存，最後動態最舊為 2026-09-01，180 天到期日 2027-02-28。零退場、零讓位。 %%

**資本支出算術（本頁計算，2026-08-29）：** Nscale 單筆 450 億美元（08-28）≈ 年化營收 650 億美元的 **69%**（450 ÷ 650 ≈ 0.69）；為本月第三筆重大算力布局（前有 AMD、Nvidia），另有 13 億美元私募信貸（08-19）、Bastrop County 資料中心洽租中（08-25）——單月算力承諾規模已逼近年化營收本身量級（推論，本頁計算）；循環融資質疑見「還沒過去的風險」表細節區。
...
- **Nscale**（2026-08-28）：簽署 450 億美元資料中心協議，取得 460 MW Vera Rubin 世代算力（Forbes；Financial Times）
  **訊 2026-09-21 追蹤**：Bloomberg 報導 Nscale 總合約值達 1,030 億美元，Anthropic 與 Microsoft 為最大兩家客戶，首度揭露 Nscale 整體規模與客戶排名（Google News/Bloomberg.com）
...
- **未具名 AI 資安新創**（2026-08-25）：與 Anthropic、Google 合作的新創獲 1.4 億美元融資（Bloomberg）
- **未具名資料中心業者（Bastrop County）**（2026-08-25）：洽談租用德州 Bastrop County 大型資料中心（KXAN Austin）
- **UpToDate**（2026-08-24）：深化與醫療資訊平台 UpToDate 的合作（Fierce Healthcare）
...
- **Naver**（2026-08-11）：南韓 Naver 投資 Anthropic 700 萬美元，屬策略聯盟訊號（KED Global）
...
- **Morgan Stanley**（2026-08-02）：領投 150 億美元，投向 Anthropic 德州校園/資料中心（thestreet.com）
- **Oxide**（2026-07-29）：加入 Project Glasswing 安全合作計畫，並用 Mythos 5 掃描自家程式碼庫（Oxide 官方部落格）
- **Surf AI**（2026-07-28）：整合 Claude Compliance API，擴展「暴露削減」業務（Yahoo Finance）
- **Cognizant**（2026-07-28）：擴大合作升級為 Claude Partner Network 全球首要夥伴，打造認證人才梯隊（Anthropic Blog）
- **SK 集團**（2026-07-26）：SK Hynix 母公司董事長透露 Anthropic 曾接洽尋求自製晶片供應（Fortune）
- **Cyberhaven**（2026-07-23）：資安平台新增支援 Claude Compliance API（PR Newswire）
- **[[entities/amir-salek|Amir Salek]]**（2026-08-21）：延攬 Google TPU 專案創辦人進 compute 團隊，向 James Bradbury 匯報（Seeking Alpha；Bloomberg）
- **AMD**（2026-07-22）：投資 Anthropic 最高 50 億美元並簽署晶片暨投資協議（Reuters；WSJ）
- **Orca Security**（2026-07-21）：整合 Claude Compliance API 至其 AI 資安平台（Business Wire）
- **Druva**（2026-07-21）：AI 韌性方案擴展至 Copilot、Claude 與 MCP（Virtualization Review）
- **UST**（2026-07-20）：與 Anthropic 合作，將 Claude 部署至其企業平台（The Fast Mode）
- **Meta（運算力租賃）**（2026-07-17）：洽談 100 億美元運算力租賃協議，三方獨立確認（Reuters；NYT）
- **FIS**（2026-07-17）：延長既有合作關係（Asset Servicing Times）
- **Deloitte**（2026-07-17）：推出由 Claude 驅動的安全軟體平台（PR Newswire）
- **Blackstone（Ode 合資公司）**（2026-07-16）：與 Anthropic 合資成立 AI 實作公司 Ode，規模 15 億美元（Technology Org；TechCrunch）
- **Claranova**（2026-07-15）：透過新 API 將 PDF 工具與 Claude 整合（Idéal Investisseur）
- **加拿大政府**（2026-07-15）：承諾投入 1,000 萬加幣支持加拿大 AI 研究（EdTech Innovation Hub）
- **Optum + UST**（2026-07-14）：透過 Optum 合作與既有夥伴 UST 整合，深入醫療產業（Fierce Healthcare）
- **Varonis**（2026-07-14）：為 Claude Code 與 Cowork 提供執行期安全防護（Stock Titan）
- **LTM**（2026-07-13）：與 Anthropic 建立合作，加速企業導入 Claude（Yahoo Finance）
- **UST**（2026-07-10）：導入 Claude 至晶片/汽車/連網裝置製造流程，訓練 2 萬名工程師（Anthropic Blog）
- **AWS（治理）**（2026-07-09）：推出集中管理 Claude 存取權限、支出與治理的企業功能（Help Net Security）
- **TeraWulf**（2026-07-06）：簽署 20 年、190 億美元肯塔基州 AI 基礎設施園區租約（WSJ；CNBC）
- **Samsung**（2026-07-06）：TechRepublic 跟進洽談三星代工客製 AI 晶片，確定性未升級（TechRepublic）
- **Google Workspace**（2026-07-06）：Claude 在 Google Workspace 內以受治理 workflow agent 運作（AiThority）
- **澳洲資料中心業者（未具名）**（2026-07-05）：計畫採購 1.4GW 澳洲資料中心容量（AFR）
- **MixRoute**（2026-07-05）：第三方路由服務宣布支援 Fable 5（Yahoo Finance）
- **企業客戶（支出控管功能）**（2026-07-04）：推出企業版 Claude 支出控管功能，回應部門預算管控呼籲（Tech Times）
- **Samsung**（2026-07-02）：The Information 首報洽談三星代工客製 AI 晶片（The Information）
...
- **Claude 營收年增 1,000%（08-28，媒體獨家，未經證實）**：Yahoo Finance 獨家報導稱 Claude 營收年增達 1,000%，在企業市場對 ChatGPT 的差距持續縮小。**單一媒體獨家、無官方確認**，具體基期、統計口徑（ARR／季營收／哪個時間窗口）均未見報導，與本頁「現在的數字」表既有 ARR 數字（$65B，2026-07）口徑是否一致待查；不可直接與官方揭露數字並列比較，僅作市場信號記錄（推論，待官方或第三方獨立驗證）。
...
- **Bastrop County 資料中心（08-25）**：KXAN Austin 引述消息人士報導 Anthropic 正洽談租用德州 Bastrop County（Cedar Creek）一座 2,842 英畝、含 710MW 燃氣電廠的資料中心園區，尚未定案。
- 已查證（2026-09-20）：**與 Morgan Stanley 案非同一設施**——Morgan Stanley 領投的 $150 億貸款案（08-02）對象是 Nexus Data Centers 在德州 Hubbard 的園區，地點、開發商均不同，兩案各自獨立（Google 為 Nexus 案提供信評擔保）。
...
- **Claude Academy（08-23）**：EdTech Innovation Hub 報導 Anthropic 推出「Claude Academy」，提供免費 AI 課程與企業導入指南；首度以自身名義面向大眾推出免費課程，具體內容、涵蓋範圍未見報導，僅標題可用（推論）。
- 08-26 跟進（ababnews.com）已查證（2026-09-20）｜**ababnews.com 可信度**：為 ABAB Labs 旗下區塊鏈財經聚合平台，有 About／Contact 頁，非假新聞站，惟非專業 AI 媒體，屬轉載聚合。
- 本則僅轉載同一消息，未見新增細節，採信度維持低於 08-23 EdTech Innovation Hub 原始報導。
...
- **Decart 交易生變（09-08）**：PYMNTS 首報 Anthropic 撤回收購計畫，同日 Bloomberg、calcalistech（兩則）、Ynetnews、Globes 密集跟進；calcalistech 一則標題暗示有分析撤回原因，惟僅標題可用，具體原因未見報導。
...
- **Oxide（07-29）**：[Oxide 官方部落格](https://oxide.computer/blog/oxide-anthropic-project-glasswing)（Hacker News，16 分，另有一家媒體同步報導）宣布加入 Anthropic 主導的 Project Glasswing——一項致力於保護全球關鍵軟體安全的合作計畫；Oxide 同時將 Claude Mythos 5 應用於自家程式碼庫的漏洞掃描（模型能力面詳見 [[entities/mythos]]）。延續近期 Okta（06-30，XAA/MCP/Glasswing 安全框架合作）、TCS（06-11，取得 Mythos Preview／Project Glasswing 存取）等既有 Glasswing 生態參與者，Oxide 是又一具名加入此安全合作計畫的科技公司，顯示 Glasswing 夥伴圈持續擴張（推論）；具體合作範疇、商業條款未見細節，僅部落格公告層級資訊。
...
- **Amir Salek（08-21起，08-23 具名確認）**：Seeking Alpha 報導 Anthropic 延攬一名前 Google 晶片工程師，據報導是評估自研晶片（in-house solution）方案、跨入硬體領域的訊號；Bloomberg 同日獨立跟進報導同一事件（標題「Anthropic Taps Google Chip Veteran as Part of Push Into Hardware」，雙重來源確認）。延續既有 Samsung 代工洽談（07-02 起，媒體持續追蹤未升級）、AMD／Micron 晶片供應鏈投資合作路線，本次首見「內部招募晶片人才」訊號，顯示 Anthropic 可能不僅止於外部代工／供應鏈合作，亦在評估自研晶片路徑，與 Google（TPU）、Amazon（Trainium）等雲端夥伴的自研晶片模式相似（推論）；具體職位、團隊規模、時程未見報導，僅標題可用。08-23 具名確認：The Times of India 報導確認該工程師身分為 Amir Salek，Google 自研晶片計畫（custom chip programme）創辦人——即 Google TPU 專案的創始人物之一。從「未具名前員工」升級為「創辦人層級具名人才」，招募對象的資歷等級遠高於一般工程師，顯示 Anthropic 自研晶片布局的企圖心可能不僅止於組建團隊，而是延攬曾成功打造 Google 整條自研晶片專案的核心創始人才，招募規格與 Google（TPU）、Amazon（Trainium）路線的可比性因此提高（推論）；**後續（2026-09-06）：** Bloomberg 載明 Salek 2013–2022 創辦並領導 Google TPU 專案（前七代），加入後進 compute 團隊、向 James Bradbury 匯報，到任日未公開；人才流動對戰力與市場意涵之完整分析詳見 [[topics/ai-talent-flow]]。08-24 跟進（citybiz，非新事實）：citybiz 轉載同一事件，未見新增職位、時程或團隊規模細節，僅為既有 08-21/08-23 記錄的又一媒體重述。
- **AMD（07-22）**：Reuters（經 Hacker News 討論，另有一家媒體同步報導）、WSJ 獨家、Yahoo Finance 三方同日報導同一事件：AMD 宣布對 Anthropic 投資最高 50 億美元，並簽署晶片暨投資協議。延續近期 Micron（06-22）、Samsung＋SK Hynix（05-28）等晶片供應鏈廠商同步入股 Anthropic 的模式，AMD 為又一起「晶片供應商轉為投資人」的具名案例；HN 留言以「ouroboros circle」（銜尾蛇循環）形容晶片商與 AI 實驗室互相投資、彼此推升估值與營收的模式，對其可持續性提出質疑（推論）；具體投資結構、股權比例、晶片供應規模未見細節，僅標題與市場反應層級資訊。07-26 跟進（單一來源，股價分析延伸，非新事實）：Barchart 發表分析文章，探討此合作對 AMD 股價的潛在影響，未見新增交易條款或規模數字，屬既有事件的股價分析延伸。
- **Orca Security（07-21）**：Business Wire 報導 Orca Security 擴充其 AI 資安平台，整合 Claude 的 Compliance API；延續近期 Varonis（07-14）、Tenable（06-29）等資安夥伴生態擴張趨勢（推論）；07-23 Security Info Watch 獨立跟進報導同一整合（雙重來源確認），僅標題可用，具體規模未見細節。
...
- [[topics/market-signals]]（把這些消息放進市場框架的判讀）
...
- **[生命科學布局，僅標題可用] Channel 3000／80 Level 跟進 09-18 已記錄之自有生物實驗室報導：Anthropic 設立生物實驗室，加速 AI 驅動藥物開發**：未見新增細節，與 09-19 TechCrunch／Yahoo Finance 同屬同一事件的持續媒體擴散（Google News/Channel 3000；Google News/80 Level）
- **[戰略合作，僅標題可用，單一來源] The Information：OpenAI 與 Anthropic 傳一度接近達成協議，擬互相對彼此 AI 模型做壓力測試**：具體條款、是否已簽署、測試範疇均未見報導，單一消息來源，細節待證實（Google News/The Information）
- **[產品策略，僅標題可用，單一來源] citybiz：Anthropic 據報考慮推出新款 Claude 模型，背景是 OpenAI 於潛在 IPO 前持續拉近差距**：具體模型規格、時程均未見報導，僅單一來源標題可用（Google News/citybiz）
- **[財務評論，僅標題可用] Financial Times（Lex 專欄）：Anthropic 估值達 2 兆美元「並非天方夜譚」**：分析文，呼應既有 08-13 記錄之 2 兆美元 IPO 估值預期（見「現在的數字」表），未見新增數字或論證細節，僅標題可用（Google News/Financial Times）

#### 2026-09-19
- **[重大事件] Anthropic 宣布 Accenture 出任首位「內嵌評估者」，獨立評估前沿 AI 安全；Washington Post 稱同步承諾投入 10 億美元資金，呼應 CEO「We Must Pace the Frontier」一文承諾**（Anthropic Blog；Google News/The Washington Post）
- **[商業風險] The Hill、Politico、Bloomberg Law News 同日報導：新提告指控 Anthropic 與 OpenAI、SpaceXAI、Google 就「踩煞車」呼籲構成反壟斷合謀**（Google News/The Hill；Google News/Politico；Google News/Bloomberg Law News）
- **[IPO前瞻] NYT：Anthropic 積極籌備 IPO，儘管公司過去屢次就 AI 安全發出警訊，形成立場對比**（Google News/The New York Times）
- **[生命科學布局] TechCrunch、Yahoo Finance 跟進 09-18 已記錄之自有生物實驗室報導：Anthropic 建置專屬濕實驗室，作為 AI 驅動藥物開發計畫一環**（Google News/TechCrunch；Google News/Yahoo Finance）
...
- **[財務狀況] The Information：11 個月內累計談成算力交易合計 5,170 億美元**：詳見「現在的數字」表新增列與細節（Google News/The Information）
- **[戰略合作] Currently.com：Anthropic 對 AWS 承諾金額已逾 1,000 億美元，招股書可能揭露更多合約細節**：屬前述 5,170 億美元總額中的單一夥伴分項，詳見「現在的數字」表細節（Google News/Currently.com）
- **[戰略合作] AI Magazine：Fluidstack 主導 Anthropic 一筆 500 億美元算力建置案**：詳見「哪個合作會改到你用的 Claude」一行制清單新增列（Google News/AI Magazine）
- **[戰略合作，推論] Yahoo Finance：Hut 8 藉 350 億美元 Anthropic 合作案加速 AI 業務轉型**：金額與地點描述與 09-01 已記錄之 Lambda 交易相符，推論為同一筆，尚待其他來源確認，詳見「哪個合作會改到你用的 Claude」Lambda 細節（Google News/Yahoo Finance）
- **[商業風險] NDTV／TechCrunch：出版商、經紀人與作者陣營為 15 億美元著作權和解金分配方式爭執，作者方公開反彈**：與既有和解案執行細節不同面向，詳見「還沒過去的風險」表細節區（Google News/NDTV；Google News/TechCrunch）
- **[商業風險] Yahoo Finance：五角大廈維持 Anthropic 採購黑名單，分析亞馬遜與 Alphabet 投資人為何該留意**：政府動作本身見 [[topics/anthropic-government-policy]]；本則聚焦投資人風險視角，本頁不重複記錄政策細節（Google News/Yahoo Finance）
- **[公司動態] EdTech Innovation Hub：Anthropic 首度對外部研究者開放真實 Claude 使用數據**（Google News/EdTech Innovation Hub）
- **[公司動態，僅標題可用] Business Insider（3 個獨立來源同步轉載）：一支小型 Anthropic 內部團隊高產出節奏側寫**：具體團隊名稱與產出內容未能擷取，僅標題可用（Google News/Business Insider）
- **[IPO 前瞻，僅標題可用] Morningstar：分析文章稱 Anthropic IPO 規模龐大同時提醒投資人留意風險**：具體風險項目原文未能擷取，與既有 Damodaran／Eisman／Chamath 等風險評論同屬市場觀感類訊號，不獨立展開（Google News/Morningstar）

#### 2026-09-06
- **[IPO 前瞻] calcalistech／ETF Trends：兩則標題方向矛盾——「IPO 時程延後」vs「IPO 申報文件解讀」**：均僅標題可用，並陳呈現，詳見「IPO 走到哪一格」表「什麼時候上市」列與細節區 ⟨Q-03⟩（Google News/calcalistech.com；Google News/ETF Trends）

#### 2026-09-04
- **[商業風險] NYT：企業界正轉向開源模型，分流 OpenAI／Anthropic 訂單**：HN 討論達 274 分，留言指若兩者不大幅降價恐面臨更大轉單壓力，詳見「還沒過去的風險」表新增列與細節（[NYT](https://www.nytimes.com/2026/09/04/technology/open-source-ai-anthropic-openai.html)）
- **[商業模式] The Information：Anthropic 自建支付技術，傳分食 Stripe 市場**：詳見「商業模式」新增細節（Google News/The Information）

#### 2026-09-03
- **[IPO 前瞻] FT／NYT：Anthropic 傳洽談由 Morgan Stanley、Goldman Sachs 主辦、估值上看 2 兆美元的 IPO**：首見具體承銷投行組合；NYT 同時分析誰是這波 IPO 潛在最大受益投資人，詳見「IPO 走到哪一格」表新增列（[FT](https://www.ft.com/content/3c9d0a82-643b-44ef-96a0-74a00e3c72ba?syn-25a6b1a6=1)；[NYT](https://www.nytimes.com/2026/09/03/technology/anthropic-ipo-investors-winners.html)）
- **[戰略合作] Skift：Amadeus 將旅遊科技整合進 Claude Code 與 Cowork**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Skift）

#### 2026-09-02
- **[戰略合作，官方一手來源] Anthropic 官方部落格：推出 Enterprise Frontier Safeguards（EFS，公告日 09-01）**：結合零資料留存（ZDR）與濫用偵測技術，**EFS 免費**，今秋起分階段開放；由 100+ 企業客戶共同開發，並與 AWS、Google Cloud、Microsoft Azure 合作，詳見「哪個合作會改到你用的 Claude」表新增列與細節（[Anthropic Blog](https://www.anthropic.com/news/enterprise-frontier-safeguards)；csoonline.com；SecurityWeek）
- **[戰略合作] AWS 官方部落格：Claude Fable 5.1 上線 AWS 平台**：雲端夥伴角度公告，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Amazon Web Services (AWS)）
- **[商業風險，推論] 24/7 Wall St.：質疑 Nvidia-Lambda-Anthropic $350 億雲端合約構成循環融資**：與本頁 09-01 的 Lambda 合約為同一筆交易，非新交易，詳見「哪個合作會改到你用的 Claude」Lambda 相關細節與「還沒過去的風險」表新增列
- **[IPO 前瞻] Stocktwits：分析師稱 Anthropic 需達微軟等級 70% 毛利率才撐得住潛在 IPO 估值**：詳見「IPO 走到哪一格」表新增列

#### 2026-09-01
- **[戰略合作] 多家媒體：Anthropic 與 Lambda 簽署 350 億美元雲端運算合約**：Lambda 為 Nvidia 支持之雲端業者，資金牽涉德州一座由比特幣礦商營運的資料中心園區；延續本頁近期密集的算力布局系列（Nscale $450 億、Riot Platforms $90 億、Volta $100 億等），詳見「哪個合作會改到你用的 Claude」表新增列（多家媒體，2026-09-01）
- **[戰略合作] crn.com：Claude 認證累計 8.5 萬張，Anthropic 擬擴大夥伴培訓規模**：延續既有 DXC（06-12，訓練數萬名認證工程師）、Cognizant（07-28，Global Premier Partner 認證人才梯隊）等培訓型合作訊號，本次首見公司層級累計認證數字，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/crn.com）
- **[戰略合作] Morningstar：Trifecta Technologies 與 Anthropic 合作導入 Claude 服務**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Morningstar）
- **[商業風險] Sony、Warner Chappell 等音樂出版商正式提告**：09-01 報導聚焦訴訟正式提交面，與 08-29/08-31 已記錄事件同一案，未見新增求償金額或新原告，不改變既有「還沒過去的風險」表記錄

### 2026-08

#### 2026-08-31
- **[戰略合作] Seeking Alpha：Amazon 將 OpenAI、Meta、Anthropic 模型帶進 AWS GovCloud**：供政府相關客戶使用，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Seeking Alpha）
- **[戰略合作] EdTech Innovation Hub：Anthropic 開放美國中小學與學區免費使用 Claude for Teachers 企業版**：延續 Claude Academy（08-23）教育普及路線，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/EdTech Innovation Hub）
- **[商業風險] technology.org／The Guardian：Sony、Warner Chappell 等音樂出版商正式提告，補上「Warner Chappell」具體法律實體名稱**：與 08-29 記錄之 Sony Music／Warner 訴訟為同一案，詳見「還沒過去的風險」表細節更新（Google News；The Guardian）
- **[投資人／股權] Business Insider：回顧 FTX 案相關人士（Sam Bankman-Fried、Caroline Ellison、Nishad Singh）持有之 Anthropic 股權遭聯邦查扣後的處置現況**：延續 2026-06-15 的「FTX 前 Anthropic 股份估值 $75B」（見下方時序 2026-06-15），本則首度補充查扣後股權**實際處置流程**的後續報導；具體處置方式（拍賣、轉予 FTX 債權人信託、或由 DOJ 直接持有待決）、目前市值換算基準、時程均未見報導，僅標題可用（Business Insider，2026-08-31）

#### 2026-08-29
- **[商業風險，升級] TechCrunch／Business Insider：Sony Music、Warner 等唱片公司控告 Anthropic 大規模非法透過 BT 下載盜版音樂訓練 Claude，求償每首歌最高 15 萬美元**：延續 08-18 記錄之音樂出版商著作權訴訟（Round Hill Music 10 億美元、另一出版商對 Anthropic/Suno），本次原告升級為主流大型唱片公司，詳見「還沒過去的風險」表更新列（Google News/TechCrunch；Google News/Business Insider）
- **[戰略合作] Wccftech：OpenAI 退出與 SpaceX 旗下 Cursor 的合作，Anthropic 加碼承接**：具體合約規模、承接比例未見報導，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Wccftech）

#### 2026-08-28
- **[戰略合作] Forbes／Financial Times：Anthropic 與英國新創 Nscale 簽署 450 億美元資料中心協議，取得 460 MW Vera Rubin 世代算力**：繼 AMD、Nvidia 後第三筆重大算力布局，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Forbes；Google News/Financial Times）
- **[戰略合作，媒體獨家未經證實] Yahoo Finance 獨家：Claude 營收年增稱達 1,000%，對 ChatGPT 差距縮小**：單一來源、無官方確認，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Yahoo Finance）
- **[戰略合作，補上具體金額] 後續報導：Meta 傳將於 Anthropic 支出達 100 億美元**：與既有 07-17 記錄之運算力租賃洽談金額相同，詳見「哪個合作會改到你用的 Claude」表 Meta 列更新（Hacker News；Google News/The New York Times）
- **[戰略合作，財報面補強] WSJ：Salesforce 財報獲利與營收雙雙成長，同步擴大與 Anthropic 合作發布 Claudeforce**：與既有 08-26 記錄為同一事件，詳見「哪個合作會改到你用的 Claude」表 Salesforce 列更新（WSJ；Salesforce 官方新聞稿）
- **[戰略合作，市場觀感角度] Yahoo Finance：財經評論員 Jim Cramer 稱 Salesforce（CRM）與 Anthropic 合作「緩解 AI 顛覆傳統 SaaS 業務之疑慮」**：與同日 WSJ 財報面補強、08-26 Claudeforce 發布為同一合作事件的市場觀感延伸；呼應本頁「產品市場契合度」段落既有「AI 是否侵蝕傳統 SaaS」討論（見 07 月〈小型企業改用 Claude 自建工作流取代 Salesforce〉一則），本則從 Salesforce 立場提供正面反例——深度整合而非被取代；具體論點內容、是否涉及股價評級調整未見報導，僅標題可用（Google News/Yahoo Finance）。

#### 2026-08-26
- **[IPO/估值敘事，正反論戰] Hacker News 雙帖＋Anadolu Ajansı／Moomoo 等：Anthropic 傳簡報宣稱 AI 服務潛在市場（TAM）上看 30 兆美元；Yahoo Finance／Marcus on AI／24/7 Wall St.（引述 Chamath Palihapitiya）提出懷疑角度**：須留意「30 兆美元市場總量」與同日 Fortune 報導「2 兆美元 IPO 估值」口徑不同，不可混淆，詳見「IPO 走到哪一格」表與「還沒過去的風險」表新增列（Hacker News；Google News/Anadolu Ajansı；Google News/Moomoo；Google News/Yahoo Finance；Google News/Marcus on AI；Google News/24/7 Wall St.；Google News/Fortune）
- **[研究資助] Anthropic Blog：啟動 500 萬美元獎助計畫，資助 AI 對使用者身心福祉影響之獨立評測研究**：屬公益/CSR 性質，詳見「這些數字是誰說的」表新增列（Anthropic Blog）
- **[戰略合作] Bloomberg：一家與 Anthropic、Google 合作之 AI 資安新創獲得 1.4 億美元融資**：新創名稱未具名，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Bloomberg.com）
- **[戰略合作，歸屬待定] ABC News：內部郵件揭露 Anthropic 澳洲 AI 佈局規模**：僅標題層級可用，具體內容未見報導，可能涉及政府合作面向，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/ABC News）
- **[戰略合作] ababnews.com：轉載 Anthropic 推出免費「Claude Academy」課程消息**：與既有 08-23 記錄為同一事件，來源可信度見「戰略合作細節」08-26 跟進段落，詳見「哪個合作會改到你用的 Claude」表更新（Google News/ababnews.com）

#### 2026-08-25
- **[基礎設施擴張] KXAN Austin：Anthropic 洽談租用德州 Bastrop County 大型資料中心**：僅標題層級可用，洽談階段非確定簽約，詳見上方「哪個合作會改到你用的 Claude」表新增列（Google News/KXAN Austin）
- **[IPO/估值敘事分歧] 24/7 Wall St. 同日刊出兩篇方向相反文章：「意圖超越 SpaceX IPO 規模」vs「估值遠遜於 SpaceX」**：兩篇並陳呈現、不擇一，詳見上方「IPO 走到哪一格」表新增列（Google News/24/7 Wall St.；Google News/Yahoo Finance）
- **[治理權分析] Bloomberg〈Who Should Control Anthropic?〉**：與既有超級投票權籌備信號同屬治理敘事，詳見上方「IPO 走到哪一格」表新增列（Google News/Bloomberg）
- **[企業採用反面訊號] cio.com：部分企業對 Anthropic 旗艦模型採用意願不如預期**：與 08-23 FT 消費者端反面訊號並置，詳見上方「產品市場契合度」反面訊號段落更新（Google News/cio.com）

#### 2026-08-24
- **[人才／文化] Axios 獨家：Anthropic 面試候選人時會詢問其如何看待「使命」與「金錢」之間的優先順序**：屬公司招募文化／人才篩選標準的具體訊號，與本頁既有「敘事整備」（07-17，Anthropic 揭露支付 60 萬美元徵才協助形塑 IPO 敘事）同屬公司對外形象經營路線，但本則聚焦招募流程本身而非公關職缺；若此為系統性面試設計，顯示公司在快速擴張＋IPO 前更看重候選人對「使命優先」文化的認同度，避免純粹逐利心態稀釋既有安全/使命導向敘事（推論）；具體面試問題全文、篩選權重、適用職級範圍未見報導，僅標題可用（Google News/Axios）。**08-25 跟進（Hacker News，36 分，補上具體引述）**：報導原文引述一名求職者（因擔憂影響未來求職機會而匿名受訪）回憶，面試官問其若公司未來因安全考量放棄 AI 願景、導致股票歸零，會作何感受——是「使命 vs 金錢」提問框架下的具體場景範例。HN 討論兩極：部分留言認為這是 Anthropic 一貫透明作風的延伸、非新聞爆點；另有留言認為此問法對一般求職者而言不近人情。屬同一報導的深化補充，未改變既有「招募文化篩選訊號」的判讀（Hacker News）
- **[市場滲透] Bloomberg.com：Anthropic 表態指出澳洲在 Claude 程式開發工具的採用速度上落後其他市場**：是本頁首見針對單一國家市場「採用落後」的官方公開表態，與既有企業採用率指標（Ramp AI Index 34.4%，全球整體數字）為不同顆粒度——本則為特定地區的相對落後評語，非全球數字修正；與 08-03 的印度市場擴大布局（在地化定價＋更普及）形成對照，顯示 Anthropic 對不同市場的滲透速度存在明顯落差，且公司願意公開點名特定市場落後（推論）；具體落後幅度、比較基準（對比美國或其他亞太市場）、Anthropic 是否有對應澳洲市場的加碼計畫均未見報導，僅標題可用（Google News/Bloomberg.com）
- **[戰略合作] EdTech Innovation Hub：Anthropic 推出「Claude Academy」，提供免費 AI 課程與企業導入指南**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/EdTech Innovation Hub）
- **[商業風險] The Daily Beacon：UT 校內學生報跟進報導 UTRF 專利侵權訴訟**：與既有 07-21 UTRF 訴訟為同一案，詳見「還沒過去的風險」表更新（Google News/The Daily Beacon）
- **[戰略合作] citybiz：轉載 Amir Salek 加入 Anthropic 消息**：與既有 08-21/08-23 記錄為同一事件，詳見「哪個合作會改到你用的 Claude」表更新（Google News/citybiz）

#### 2026-08-22
- **[IPO 前瞻，首見具體募資金額] The New York Times：Anthropic 據傳評估在 IPO 中募資高達 1,000 億美元**：詳見「IPO 走到哪一格」表新增列（Google News/The New York Times）

#### 2026-08-21
- **[IPO 前瞻] CNBC（消息人士）：Anthropic IPO 申報文件將把「AI 反彈情緒」列為風險因素之一**：詳見「IPO 走到哪一格」表新增列（Google News/CNBC）
- **[IPO 前瞻] Financial Times：整理散戶投資人參與 Anthropic IPO 前需留意的重點**：詳見「IPO 走到哪一格」表新增列（Google News/Financial Times）
- **[戰略合作，首見晶片人才招募訊號] Seeking Alpha／Bloomberg（雙重來源確認）：Anthropic 延攬前 Google 晶片工程師，評估自研晶片方案跨入硬體領域**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Seeking Alpha；Bloomberg.com）

#### 2026-08-20
- **[IPO 前瞻] Bloomberg：Anthropic 據傳預期 IPO 規模將比肩甚至超越 SpaceX 先前紀錄發行規模；Yahoo Finance：Anthropic 有可能最快本月遞交 IPO 文件**：均僅標題可用，詳見「IPO 走到哪一格」表新增列（Google News/Bloomberg.com；Google News/Yahoo Finance）
- **[戰略合作] crn.com／Seeking Alpha／The Information：與 Anthropic 關聯之 Ode 收購顧問公司 Casper Studios**：延續 07-16 的 Ode 合資公司動態，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/crn.com；Google News/Seeking Alpha；Google News/The Information）
- **[計費/合規政策，詳見 pricing] 路透社／彭博社（消息人士）：Anthropic 據傳計畫調整企業資料保留政策**：當時未經官方證實，本頁不重複列出，詳見 [[entities/pricing]]「定價與促銷」（**後續（2026-09-03）**：官方版本即 09-01 公告的 Enterprise Frontier Safeguards，見本頁「哪個合作會改到你用的 Claude」EFS 列）；競爭面（OpenAI 零資料保留承諾）詳見 [[topics/competitor-landscape]]（Google News/Reuters；Google News/Bloomberg.com）
...
- **[財務狀況] CNBC：Anthropic 已超越 OpenAI 成為市場最熱門 AI 新創（含股票贏家/輸家分析）**：詳見「這些數字是誰說的」表新增列（Google News/CNBC）
- **[財務狀況，安全面另見 ai-agent-safety] The Information：OpenAI 安全政策追上 Anthropic 之際，Anthropic 營收領先幅度仍在擴大**：本頁僅記錄商業面，詳見「這些數字是誰說的」表新增列（Google News/The Information）
- **[IPO 前瞻，分析文章] Motley Fool：若 IPO 估值傳聞成真，Amazon 持有 Anthropic 股份價值恐超過 $4,000 億美元**：詳見「IPO 走到哪一格」表新增列（Google News/The Motley Fool）
- **[戰略合作] Yahoo Finance：與 Anthropic 相關資料中心取得 13 億美元私募信貸貸款**：未具名資料中心，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Yahoo Finance）

#### 2026-08-19
- **[IPO 前置動作] Reuters：Anthropic 傳保留創辦人超級投票權**：引述 The Information，僅標題可用，詳見「IPO 走到哪一格」表新增列（Google News/Reuters）
- **[IPO 前置動作] Bloomberg：Anthropic 上市前信用額度傳擴大至逾 100 億美元**：僅標題可用，詳見「IPO 走到哪一格」表新增列（Google News/Bloomberg.com）
- **[商業風險] The Hollywood Reporter／Reuters：Round Hill Music（10 億美元求償）與另一家音樂出版商對 Anthropic、Suno 提起著作權侵權訴訟**：音樂產業首度具名著作權訴訟，詳見「還沒過去的風險」表新增列（Google News/The Hollywood Reporter；Google News/Reuters）
- **[財務狀況，多來源含相反訊號] WSJ／CoinDesk／SiliconANGLE：OpenAI 第二季業績落後 Anthropic；The Information：OpenAI 在 OpenRouter 客戶占比回升**：詳見「這些數字是誰說的」表新增列（Hacker News/WSJ；Google News/CoinDesk；Google News/SiliconANGLE；Google News/The Information）
...
#### 2026-08-18
- **[IPO 前瞻／財務狀況，重大，四方同步報導] Bloomberg、Reuters、CNBC、Benzinga：Anthropic 年化營收站上 $65B（7 月數字）**：CNBC 引述消息稱 Anthropic 已向投資人透露；詳見「IPO 走到哪一格」表新增列與「現在的數字」表更新（Google News/Bloomberg；Google News/Reuters；Google News/CNBC；Google News/Benzinga）
- **[財務狀況，補充] TechRadar／Hacker News（22 分）：Anthropic 定價最高卻拿下最多 AI token 營收（Vercel 數據，7 月）**：延續 08-15 的「Apple of AI」框架，補上 Vercel 統計佐證，詳見「這些數字是誰說的」表更新列（Hacker News）
- **[商業風險，單一來源] The Information：探討 Anthropic、OpenAI 是否將停止把最強模型販售給企業客戶**：僅標題可用，詳見「還沒過去的風險」表新增列（Google News/The Information）

#### 2026-08-15
- **[IPO 前瞻，重大，首見具體遠期預測數字] Reuters 獨家：IPO 估值取決於 2028 年 $190–200B 營收預測**：知情人士消息，未經官方證實，詳見「IPO 走到哪一格」表新增列（[Reuters](https://www.reuters.com/business/anthropic-ipo-valuation-hinges-190-200-billion-2028-revenue-forecast-sources-say-2026-08-15/)）
- **[財務狀況，首見具體單季數字] Yahoo Finance：2026 Q2 營收超過 $115 億美元**：詳見「這些數字是誰說的」表新增列（Google News/Yahoo Finance）
- **[IPO 前瞻，評論文章] Forbes：以 2 兆美元估值切入討論 AI 泡沫疑慮**：延續 08-13 的估值傳聞，屬評論性分析，詳見「IPO 走到哪一格」表新增列（Google News/Forbes）
- **[財務狀況] Business Journals：Anthropic 合資企業於 Raleigh 招聘，最高職缺薪資逾 $60 萬美元**：詳見「這些數字是誰說的」表新增列（Google News/The Business Journals）

#### 2026-08-14
- **[IPO 前瞻] CNBC（雙重來源確認）：CFO Krishna Rao 已展開早期 IPO 相關投資人會議，尚未討論估值**：詳見「IPO 走到哪一格」表新增列（Google News/CNBC）
- **[IPO 前瞻] Gizmodo：投資人評估估值上看 2 兆美元**：與同日 CFO 投資人會議報導並置，屬投資人一方評估／臆測，詳見「IPO 走到哪一格」表新增列（Google News/Gizmodo）

#### 2026-08-13
- **[戰略合作，收購洽談，跨多來源] Bloomberg、Reuters、calcalistech、Gizmodo：Anthropic 傳洽購世界模型新創 Decart，約 60 億美元**：calcalistech 指出 Decart 為以色列 AI 新創；Hacker News 討論串出現質疑聲音，詳見「哪個合作會改到你用的 Claude」表新增列（Hacker News；Google News/Reuters；Google News/calcalistech；Google News/Gizmodo；Bloomberg 原文）
- **[IPO 前瞻] PYMNTS、Financial Times（雙重來源確認）、WSJ：Anthropic 評估上看 2 兆美元估值、規劃創紀錄 IPO**：三則均僅標題可用，詳見「IPO 走到哪一格」表新增列（Google News/PYMNTS；Google News/Financial Times；Google News/WSJ）
- **[財務分析，單一來源，非新增融資] Yahoo Finance：Nvidia 對 OpenAI、Anthropic 等公司合計約 700 億美元投資的潛在股東回報分析**：僅標題可用，詳見「這些數字是誰說的」表新增列（Google News/finance.yahoo.com）

#### 2026-08-11
- **[戰略合作] Anthropic 與 Riot Platforms 簽署 20 年、90 億美元雲端協議；另與 GIC、Macquarie 洽談資料中心開發**：多家媒體報導，詳見「哪個合作會改到你用的 Claude」表新增三列（多家媒體）
- **[戰略合作] 南韓 Naver 投資 Anthropic 700 萬美元**：KED Global 報導，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/KED Global）
- **[IPO 前瞻] WSJ：Anthropic IPO 前設法穩固投資人信心**：詳見「IPO 走到哪一格」表新增列（Google News/WSJ）
...
- **[法律風險，🔎 查無新訴訟證據]** The Post-Crescent 報導 Anthropic 因訓練 AI 使用受版權保護書籍遭提告：查證（2026-08-13，複查 2026-09-13）後查無獨立於既有 15 億美元著作權集體訴訟和解案的新案報導，高度疑似地方報重提舊案，惟未能取得原文 100% 排除新案可能，詳見「還沒過去的風險」表對應列（Google News/The Post-Crescent）
...
- **[戰略合作] Millennium 與 Anthropic 合作開發 AI 風險分析師**：Yahoo Finance（三重來源確認）報導，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Yahoo Finance）
- **[戰略合作] AWS 攜手 Anthropic、OpenAI 推出 AWS Continuum**：AWS 官方宣布，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/AWS）
...
#### 2026-08-04
- **[戰略合作] Anthropic 與新創雲端運算商 Volta 簽署 100 億美元運算協議**：TechCrunch、The Telegraph（補充：僅成立八個月的英國新創）、TipRanks（補充：獲 Nvidia 支持）三方同日報導同一事件，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/TechCrunch；Google News/The Telegraph；Google News/TipRanks）
- **[戰略合作] SpaceX 財報揭露 Anthropic／Google 運算合作推升營收翻倍**：TechCrunch 報導，詳見「哪個合作會改到你用的 Claude」表新增列（Google News/TechCrunch）
...
#### 2026-08-02
- **[戰略合作，基礎設施擴張] Morgan Stanley 領投 150 億美元 Anthropic 德州資料中心校園投資案**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/thestreet.com）

### 2026-07

#### 2026-07-29
- **[戰略合作] Oxide 加入 Project Glasswing**：詳見「哪個合作會改到你用的 Claude」表新增列（Oxide 官方部落格；Hacker News，16 分，雙重來源確認）
- **[戰略合作，媒體重複報導] Yahoo Finance 重申 Meta 與 Anthropic 早期洽談 100 億美元運算力租賃**：與 07-17 的 Reuters／NYT／Hacker News 三方報導事實一致（金額、洽談階段均未變），未見新增條款或進展，維持既有「哪個合作會改到你用的 Claude」表 Meta 列不動，用詞保守——仍屬早期洽談，非確定簽約（Google News/Yahoo Finance）
- **[戰略合作，資安/合規生態擴張] Surf AI 宣布整合 Claude Compliance API**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Yahoo Finance）
...
- **[競品動態，詳見 competitor-landscape] The Information（三重來源確認）：儘管 Codex 與開源模型討論度上升，Claude Code 採用黏著度仍領先**：詳見 [[topics/competitor-landscape]]
...
#### 2026-07-28
- **[IPO 前瞻] Axios：市值已超越 Starbucks 與 McDonald's**：首見以消費品牌市值作對照基準，詳見「IPO 走到哪一格」細節區（Google News/Axios）

#### 2026-07-25
- **[著作權和解案，媒體擴散] CNN 跟進報導 Anthropic 將支付《哈利波特》系列出版商和解賠款**：與 07-22～24 已記錄事實相同，未見新增金額或細節，詳見「這些數字是誰說的」表更新（Google News/CNN）
- **[戰略合作，單一來源跟進] MarketScale 重申 Blackstone／Ode 合資公司「企業 AI 價值在於實作而非模型」定位**：與既有 07-15/16 TechCrunch／Technology Org 報導方向一致，本則單一來源，尚待其他媒體佐證，詳見「哪個合作會改到你用的 Claude」表更新（Google News/MarketScale）
- **[IPO 前瞻] Yahoo Finance：Anthropic 被類比為「ETF 發行商版 SpaceX」**：詳見「IPO 走到哪一格」表新增列（Google News/Yahoo Finance）
...
#### 2026-07-24
- **[估值訊號] Bloomberg：Alphabet 持有 Anthropic 股權市值跳升至約 1,240 億美元**：詳見「IPO 走到哪一格」表新增列、[[entities/google-investment]] 時序（Google News/Bloomberg.com）
- **[戰略合作，資安生態擴張] Cyberhaven 新增支援 ChatGPT Enterprise 與 Claude Compliance API 整合；Orca Security 07-21 整合再獲二次確認**：詳見「哪個合作會改到你用的 Claude」表新增列/更新（Google News/PR Newswire；Google News/Security Info Watch）
- **[著作權和解案，媒體擴散] NDTV 跟進報導《哈利波特》系列出版商將獲數百萬美元賠付**：與 07-22/23 已記錄事實相同，未見新增細節，詳見「這些數字是誰說的」表更新（Google News/NDTV）
...
- **[IPO 敘事，兩則標題層級報導，無新增查證數字] SF Chronicle、24/7 Wall St. 同日探討 Anthropic／OpenAI 兆美元估值 IPO 前景**：San Francisco Chronicle 分析 OpenAI 與 Anthropic 未來可能以數兆美元估值掛牌上市，探討舊金山當地能否受益；24/7 Wall St. 評論文章稱兆美元估值的 Anthropic IPO「已成定局」，作者表示不會投資。**注意**：兩則均僅標題可用，未見具體估值數字、時程或官方確認，延續既有「IPO 走到哪一格」表所記錄的市場臆測層級訊號，暫不新增正式表格列（該表僅收錄有具體查證數字或事件的條目），僅記錄為既有敘事延續（Google News/San Francisco Chronicle；Google News/24/7 Wall St.）
...
- **[著作權和解案再添細節，四媒體跟進] The Guardian：《哈利波特》系列出版商將獲數百萬美元賠付**：詳見「這些數字是誰說的」表新增列（The Wenatchee World；Jurist.org；The Guardian；WXYZ Channel 7）
...
#### 2026-07-22
- **[重大，晶片供應鏈＋投資，三媒體同步] AMD 宣布對 Anthropic 投資最高 50 億美元，簽署晶片暨投資協議**：詳見「哪個合作會改到你用的 Claude」表新增列（Reuters／Hacker News；Google News/WSJ；Google News/Yahoo Finance）
...
- **[商業合作，次要，兩則資安廠商整合] Orca Security 與 Druva 分別擴充其資安/韌性平台整合 Claude API**：詳見「哪個合作會改到你用的 Claude」表新增列（Business Wire；Virtualization Review）
...
- **[估值對照，第三方分析，資訊量少] Morningstar：Databricks 40% 估值漲幅相較 Anthropic 估值規模「近乎微不足道」**：Morningstar 分析文章比較 Databricks 40% 估值成長與 Anthropic 近期估值變化規模的差距，暗示 Anthropic 估值漲幅遠超過 Databricks。**注意**：屬第三方媒體視角的產業估值對照，未提供具體數字換算，暫不列入「IPO 走到哪一格」正式表格（該表僅收錄有具體查證數字或事件的條目），僅記錄為市場對 Anthropic 估值規模的又一佐證（推論）（Google News/Morningstar）
- **[人才/資本外溢，個人投資者身分，非公司戰略合作] 推論運算新創 Infinity 獲 Touring Capital 及 OpenAI／Anthropic 研究員個人投資，融資 1500 萬美元**：TechCrunch 報導推論運算新創 Infinity 獲得 1500 萬美元融資，投資方包含 Touring Capital 及來自 OpenAI 與 Anthropic 的研究員（個人投資者身分，非公司直接投資）。**注意**：屬 Anthropic 員工個人投資行為外溢至新創生態圈的訊號，非 Anthropic 公司戰略合作或投資，不列入「哪個合作會改到你用的 Claude」表；具體研究員姓名、投資金額佔比未見報導（TechCrunch）

#### 2026-07-20
- **[IPO 前瞻，創投表態] Yahoo Finance UK：具名創投人士看好 Anthropic IPO 前景優於 OpenAI**：詳見「IPO 走到哪一格」表新增列（Google News/Yahoo Finance UK）
- **[IPO 前瞻，財務前置動作，07-19 報導] Anthropic 傳出仿效 SpaceX 模式尋求數十億美元信貸額度**：詳見「IPO 走到哪一格」表新增列（Google News/Yahoo Finance）
- **[戰略合作，UST 合作範疇疑似再擴大] The Fast Mode：UST 與 Anthropic 合作部署 Claude AI 至企業平台**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/The Fast Mode）
- **[政府/機構評估階段，非確定採用] AI News：美國公共衛生機構據報將測試 OpenAI 與 Anthropic AI 模型**：報導稱美國公共衛生機構將測試 OpenAI 與 Anthropic 的 AI 模型。**注意**：原文摘要遭 RSS 截斷，僅知「測試」而非確定採用，屬評估階段，暫不列入「哪個合作會改到你用的 Claude」表（正式採用需先有確認事件），待後續報導補充具體機構名稱、測試範圍與結果後再評估（Google News/AI News）
...
- **[運算力供給側，媒體持續追蹤，未見新金額] Meta 與 Anthropic 運算力合作洽談持續有媒體報導**：Yahoo Finance（「Meta weighs up to $10bn AI compute deal with Anthropic」）、Techzine Global（「Meta is exploring the possibility of leasing AI capacity to Anthropic」）同日報導，延續 07-17/18 已記錄的 Meta 100 億美元運算力租賃洽談（見「哪個合作會改到你用的 Claude」表 07-17 列），惟兩則報導金額與既有數字一致（$10bn=100億美元），未見新增具體細節，屬既有訊號的持續媒體確認而非新事實（Google News/Yahoo Finance；Google News/Techzine Global）
...
- **[廣告爭議，內容首度揭露，補上 07-18 缺口] TechCrunch：Anthropic 最新廣告《There's hope in hard questions》以監控、街友、墓地、礦工等陰暗意象引發部分觀眾不安**：Hacker News 轉載 TechCrunch 報導（39 分，社群熱度中等），廣告以一棟燃燒的房屋畫面開場，穿插監控人群的人臉辨識鏡頭、街頭露宿者、成排墓碑、礦工勞動等意象，搭配旁白提問，讓部分觀眾感到不安。**對商業的意涵**：補上 07-18 已記錄「Time Magazine 評論廣告反彈聲浪」條目當時缺失的具體廣告內容細節；一則以「艱難提問中蘊含希望」為主題卻大量使用陰暗意象的廣告，在 Anthropic 積極整備 IPO 敘事（見「IPO 前瞻」07-17 條目 60 萬美元徵才）之際引發不安觀感，可能是品牌敘事與公眾觀感之間的另一處摩擦點（推論）（Hacker News → TechCrunch，score 39，07-18 23:50 UTC）
...
#### 2026-07-18
- **[重大，算力供給側，三方交叉驗證] Meta 據報洽談以 100 億美元規模租賃運算力予 Anthropic**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Reuters；Google News/The New York Times；Hacker News）
...
- **[IPO 敘事，媒體擴散確認] Yahoo Finance Singapore 跟進報導 Anthropic 60 萬美元 IPO 敘事職缺**：與 07-17 已記錄的 Business Insider 首報為同一事實（$600,000 徵才協助形塑 IPO 前華爾街敘事），本次為另一獨立媒體跟進報導，強化該訊號的傳播度，非新增事實（Google News/Yahoo Finance Singapore）
...
#### 2026-07-17
- **[IPO 敘事整備，具體金額首見] Anthropic 揭露將支付 60 萬美元徵才形塑其「棘手 IPO 敘事故事」**：Business Insider 報導 Anthropic 將支付 $600,000 尋人協助形塑其 IPO 前敘事。**對商業的意涵**：詳見「IPO 走到哪一格」表新增列（Google News/Business Insider）
- **[戰略合作，金融科技延續] FIS 與 Anthropic 延長既有合作關係**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Asset Servicing Times）
- **[戰略合作，顧問服務商產品化] Deloitte 推出 Claude 驅動的安全軟體平台**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/PR Newswire）
...
#### 2026-07-16
- **[重大，商業模式擴張] Anthropic 與 Blackstone 共同成立 $15 億美元 AI 實作公司「Ode」**：Technology Org 報導 Anthropic 與私募巨頭 Blackstone 共同成立名為 Ode 的 AI 實作（implementation）公司，規模達 15 億美元；TechCrunch（07-15）分析文章同步指出，兩者押注「下一個兆美元級 AI 商機在於實作，而非模型本身」。**對商業的意涵**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Technology Org；Google News/TechCrunch）

#### 2026-07-15
- **[IPO 進程加溫，跨三媒體同步] Anthropic 據稱安排 IPO 前投資人會議，銀行家介入協調**：Yahoo Finance、CNBC（雙重來源確認）、Bloomberg（雙重來源確認）三家財經媒體同步報導 Anthropic 正安排上市前一系列投資人會議。**對估值/IPO 進程的意涵**：詳見「IPO 走到哪一格」表新增列（Google News/Yahoo Finance；Google News/CNBC；Google News/Bloomberg.com）
- **[官方降本論述] Anthropic 官員：停止使用 AI 是面對成本疑慮的「錯誤」回應**：Business Insider 報導一位未具名 Anthropic 官員表示，企業或個人面對 AI 使用成本疑慮時，「停止使用 AI」並非正確的因應方式。**對商業的意涵**：屬官方對「補貼不可持續」「定價透明度危機」等既有商業風險（見「還沒過去的風險」表）的公開防禦性論述，時間點緊接 07-12/13 已記錄的 1660 萬美元帳務錯誤揭露與企業支出控管功能上線，可能是在回應 [[topics/enterprise-cost-management]] 長期累積的企業成本焦慮敘事（推論）；僅標題可用，未見官員姓名與完整發言脈絡（Google News/Business Insider）
- **[研究資助，地緣佈局] Anthropic 承諾投入 1,000 萬加幣支持加拿大 AI 研究**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/EdTech Innovation Hub）
- **[生態合作] Claranova 透過新 API 將 PDF 工具與 Claude 整合**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Idéal Investisseur）
...
#### 2026-07-14
- **[醫療產業擴張] Anthropic 透過 Optum 合作與 UST 整合深入醫療產業**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Fierce Healthcare，雙重來源確認）
- **[資安生態合作] Varonis 為 Claude Code 與 Cowork 提供執行期安全防護**：詳見「哪個合作會改到你用的 Claude」表新增列（Google News/Stock Titan）
- **[媒體擴散] Hacker News 延燒 07-11 已記錄的 Mission Local 6.5 萬美元職缺爭議報導**：Hacker News（連結 missionlocal.org，score 28）轉載延燒 07-11 已記錄的 Mission Local 報導——Anthropic 開出年薪 $65,000–$85,000 職缺（生物/生化研究職），較舊金山中位數收入低約四成，爭議浮現於公司估值約 $965B、IPO 熱潮期間。**注意**：本次為社群平台對同一報導的延伸討論，非獨立新事實，HN 28 分、社群熱度不高，僅補充社群關注度訊號（Hacker News → missionlocal.org https://missionlocal.org/2026/07/anthropic-sf-affordability-ipo-housing-evictions-rent/）
...
- **[帳務錯誤重大揭露] Anthropic 證實 1660 萬美元帳務錯誤，稽核發現企業多收 170 萬美元**：Tech Times 報導 Anthropic 證實一筆 1660 萬美元的帳務錯誤，稽核人員另發現企業客戶被多收 170 萬美元。**對商業的意涵**：是目前已知規模最大的具體揭露帳務錯誤金額，延續既有「定價透明度危機」商業風險（見「還沒過去的風險」表），可能在企業支出控管功能剛上線（07-04）之際加深企業客戶對計費可靠性的疑慮（推論）；計費細節與歷史脈絡見 [[entities/pricing]]（Tech Times https://www.techtimes.com/articles/320266/20260712/anthropic-confirms-166m-billing-error-auditors-find-17m-enterprise-overcharges.htm）
- **[企業客戶擴張] LTM 宣布與 Anthropic 合作，加速企業導入 Claude**：Yahoo Finance 報導 LTM 與 Anthropic 建立合作關係，以加速 Claude 導入並擴大企業端服務範圍；具體規模與合約金額未公開（詳見「哪個合作會改到你用的 Claude」表）（Yahoo Finance https://finance.yahoo.com/technology/ai/articles/ltm-partners-anthropic-accelerate-claude-113000192.html）
...
- **[企業服務案例] Channel Dive 報導 Caylent 案例：Claude Partner Network 內部視角觀察**：Channel Dive 報導雲端服務商 Caylent 作為 Claude Partner Network 成員的具體運作視角，延續 Partner Network 持續擴張的既有趨勢（詳見「哪個合作會改到你用的 Claude」表）（Channel Dive「A view from inside Anthropic's Claude Partner Network」）

#### 2026-07-09
- **[IPO 前瞻] Yahoo Finance：IPO 若成真，將為早期投資人帶來「意外之財」**：首見從投資人回報視角切入，暗示 IPO 進入具體討論階段，詳見「IPO 走到哪一格」細節區（[Yahoo Finance](https://finance.yahoo.com/markets/stocks/articles/anthropics-ipo-lead-windfall-profits-092600849.html)）
...
- **[企業治理功能上線] AWS 推出集中管理 Claude 存取、支出與治理功能**：Help Net Security 報導 AWS 推出功能協助企業集中管理 Claude 的存取權限、支出與治理；與 07-01 Enterprise Gateway 同屬簡化企業導入路線的產品化延伸（詳見「哪個合作會改到你用的 Claude」表）
