...
| 五角大廈供應鏈風險黑名單（08-28 一審裁定違法、即時解除；國防部 09-07 加碼維持立場、09-11 傳計畫十月前遷出全部機密 AI 工作負載、09-26 官方證實約 90% 已遷出；最後動態 09-26） | 進行中 | 不會：本案管的是聯邦機構採購與使用，不及於商用訂閱與 API | 2026-10（DOD 官方證實約 90% 已遷出，估十月底前完成，查證 2026-09-26）；D.C. 巡迴第二案待判，法院未排定日期 | 法院文件＋跨 3 媒體＋DefenseScoop＋國防部官方聲明 |
