...
| 五角大廈供應鏈風險黑名單（08-28 一審裁定違法、即時解除；國防部 09-07 加碼維持黑名單立場；最後動態 09-07） | 進行中 | 不會：本案管的是聯邦機構採購與使用，不及於商用訂閱與 API | D.C. 巡迴第二案待判，法院未排定日期 | 法院文件＋跨 3 媒體 |
