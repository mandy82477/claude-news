...
| 中國線（08-31 中國設條件；09-11 稱非法蒸餾攻擊；09-14 稱中國政府相關行為者利用 Claude 追蹤異議人士；最後動態 09-14） | 觀察 | 不會：改變的是 Anthropic 與中國的關係，不改變你的存取條件；香港見第 1 列 | 2026-09-09（阿里巴巴蒸餾指控複查日） | 混合（見表下） |
