...
| 中國線（08-31 中國官方為美中 AI 對話設條件；09-11 官方稱中國 AI 實驗室非法蒸餾攻擊、指 Moonshot 暗中導流用戶請求；最後動態 09-11） | 觀察 | 不會：改變的是 Anthropic 與中國的關係，不改變你的存取條件；香港見第 1 列 | 2026-09-09（阿里巴巴蒸餾指控複查日） | 混合（見表下） |
