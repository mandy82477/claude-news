...
> **最新動態**（2026-07-22）
> 白宮官員指控中國 Moonshot AI 從 Anthropic 的 Fable 模型「蒸餾」竊取技術，美國財政部隨後揚言對 Moonshot 祭出制裁（TechCrunch、南華早報經 Google News 轉載，2026-07-22，僅標題可用，制裁具體對象、範圍與法源依據待核實）。此為繼 2026-06-10 Anthropic 自行致函參議院指控阿里巴巴 2,880 萬次蒸餾攻擊後第二起蒸餾攻擊指控，且首度由白宮官員直接點名並升級至財政部制裁層級，性質從「企業單方指控」升級為「政府對政府」攻防。出口管制主線本身已於 07-01 落幕（詳見「## 摘要」）；中美 AI 工具信任對峙已於 2026-07-12 整合拆出至獨立頁 [[topics/safety-china-trust-dispute]]；07-13～07-22 Mythos 跨界表態（金融監管、高管、國會、政府內部矛盾）完整綜合敘事見「🚫 出口管制」戰場段落。
...
| Moonshot 蒸餾指控與財政部制裁威脅（新增） | 白宮官員指控中國 Moonshot AI 從 Fable「蒸餾」竊取技術，財政部揚言祭出制裁；僅 TechCrunch、南華早報兩則標題式報導（經 Google News 轉載），制裁對象、範圍、法源依據均未見報導（2026-07-22） | Moonshot 是否回應；財政部是否公布具體制裁措施；是否與 06-10 阿里巴巴蒸餾指控構成同一政策脈絡或屬獨立案件；模型面詳見 [[entities/fable-5]] |
