...
- **中國線**：08-31 官方表態不滿、設條件；09-02 官媒指控雙重標準，並陳不合併。併入阿里巴巴蒸餾指控（滿 90 天為 2026-11-08）與 Moonshot 蒸餾指控。09-11 Anthropic 9 月威脅情報報告新增「中國 AI 實驗室非法蒸餾攻擊」指控，並稱 Moonshot 曾暗中將用戶請求導向 Claude 處理——與既有 07-22 蒸餾指控性質不同（本次為挪用而非訓練），僅標題/摘要可用，具體實驗室名單與技術方法未見報導。08-13 後見「## 時序」；07-11 前見 [[topics/safety-china-trust-dispute]]。
