...
截至 2026-06-21（封鎖第 9 天），Fable 5 與 Mythos 5 仍處於全球停用狀態，管制令尚未撤銷。Trump G7 峰會後首度鬆口，稱 Anthropic「行為非常負責任」，為管制啟動以來最明顯的態度轉變，但外國公民存取仍需美方審批。David Sacks 同日揭露失去白宮信任的根本原因：NSA 指稱 Mythos 能在數小時內入侵機密系統，加上越獄漏洞報告。

---

## 目前局勢（截至 2026-06-21）

- **管制狀態：** Fable 5 封鎖進入第 9 天，管制令仍未撤銷；Trump G7 峰會後首度公開軟化態度，稱 Anthropic「行為非常負責任」，但尚未發出任何正式解封指令
- **政府態度轉變：** Trump 在 Axios 採訪中暗示可能放寬 Fable 5 與 Mythos 的出口管制，為管制啟動以來最明顯的鬆口訊號；外國公民存取最強模型仍需美方審批，現行管制令仍在效力中
- **信任缺口核心：** David Sacks 揭露 Anthropic 失去白宮信任的根本原因——Mythos 被 NSA 指稱能在數小時內入侵幾乎所有機密系統，加上越獄漏洞報告，成為管制的核心觸發因素
- **戰略論述風險：** FT 分析指出 Anthropic 長年強調模型危險性的安全倡導策略可能自食其果：「你越說自己的 AI 有多危險，政府就越想管你」；此論述出現於 2026-06-15 Stratechery 分析後，FT 進一步深化
- **社群質疑 NSA 論點：** HN 討論指出若 Mythos 能入侵機密系統，其他模型（含開源）在更長時間也能做到，管制閉源模型並非根本解法
