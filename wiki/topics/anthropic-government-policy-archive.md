---
page: "topics/anthropic-government-policy-archive"
kind: "topic"
status: "resolved（封存頁）"
domain: "🏛️ 政策/安全"
...
---
# Anthropic 與政府政策 — 原始條目封存

**狀態：** resolved（封存頁）
**領域：** 🏛️ 政策/安全
**上層：** [[topics/anthropic-government-policy]]
**開始日期：** 2026-05-01
**最後更新：** 2026-09-04
**最後新聞更新：** 2026-06-30

> **原始條目封存**（2026-09-04）
> 本頁為 [[topics/anthropic-government-policy]] 的時序原始條目封存，一字未刪；重點層（時段總結、目前局勢、攻防紀錄）見主頁。

---

## 2026-06

### 2026-06-30 ～ 2026-06-27（解封進展）
...
- 各筆事件的完整敘述見本頁下方「攻防紀錄（2026-06，自主頁封存）」表格對應日期列
