...
| 目前前 5 | ★ | 一句話 |
|---|---|---|
| [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) 🧭 📰 | 120,787 | Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowle… |
| [Egonex-AI/Understand-Anything](https://github.com/Egonex-AI/Understand-Anything) 🧭 📰 | 83,827 | Graphs that teach > graphs that impress. Turn any code into an interactive knowledge grap… |
| [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) 🧭 📰 | 71,915 | Pre-indexed code knowledge graph, auto syncs on code changes, for Claude Code, Codex, Gem… |
| [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | 44,381 | High-performance code intelligence MCP server. Indexes codebases into a persistent knowle… |
| [getzep/graphiti](https://github.com/getzep/graphiti) | 31,098 | Build Real-Time Knowledge Graphs for AI Agents |

| 本週竄升 | 七日增量 | ★ 現值 |
|---|---|---|
| [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) | +2,523 | 120,787 |
| [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | +869 | 44,381 |
| [Egonex-AI/Understand-Anything](https://github.com/Egonex-AI/Understand-Anything) | +787 | 83,827 |
| [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) | +777 | 71,915 |
| [topoteretes/cognee](https://github.com/topoteretes/cognee) | +217 | 30,942 |
...
| [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) | 69,982 | Spec-driven development (SDD) for AI coding assistants. |
...
| 本週竄升 | 七日增量 | ★ 現值 |
|---|---|---|
| [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) | +1,482 | 69,982 |
...
| [awslabs/aidlc-workflows](https://github.com/awslabs/aidlc-workflows) | 4,787 | AI-Driven Life Cycle (AI-DLC) adaptive workflow steering rules for AI coding agents |
...
| [WorldFlowAI/everything-claude-code](https://github.com/WorldFlowAI/everything-claude-code) | +526 | 3,501 |
...
| 目前前 5 | ★ | 一句話 |
|---|---|---|
| [stablyai/orca](https://github.com/stablyai/orca) 📰 | 76,321 | Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with yo… |
...
| [Devin-AXIS/iPolloWork](https://github.com/Devin-AXIS/iPolloWork) | 6,607 | Enterprise-grade, local-first Agent Workbench for people and agent teams. A unified multi… |

| 本週竄升 | 七日增量 | ★ 現值 |
|---|---|---|
| [stablyai/orca](https://github.com/stablyai/orca) | +6,296 | 76,321 |
| [ApodexAI/FrontierAgent](https://github.com/ApodexAI/FrontierAgent) | +1,156 | 4,515 |
| [Devin-AXIS/iPolloWork](https://github.com/Devin-AXIS/iPolloWork) | +428 | 6,607 |
...
| 目前前 5 | ★ | 一句話 |
|---|---|---|
| [TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) | 27,202 | TencentDB Agent Memory is a team-level memory hub for AI Agents — turning conversations,… |
...
| 本週竄升 | 七日增量 | ★ 現值 |
|---|---|---|
| [TencentCloud/TencentDB-Agent-Memory](https://github.com/TencentCloud/TencentDB-Agent-Memory) | +372 | 27,202 |
