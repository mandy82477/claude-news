...
| 目前前 5 | ★ | 一句話 |
|---|---|---|
| [multica-ai/andrej-karpathy-skills](https://github.com/multica-ai/andrej-karpathy-skills) 🧭 📰 | 209,830 | A single CLAUDE.md file to improve Claude Code behavior, derived from Andrej Karpathy's o… |
| [Piebald-AI/claude-code-system-prompts](https://github.com/Piebald-AI/claude-code-system-prompts) 📰 | 12,567 | All parts of Claude Code's system prompt, 27 builtin tool descriptions, sub agent prompts… |
...
| [gadievron/raptor](https://github.com/gadievron/raptor) | 3,706 | Raptor turns Claude Code into a general-purpose AI offensive/defensive security agent. By… |
| [centminmod/my-claude-code-setup](https://github.com/centminmod/my-claude-code-setup) | 2,618 | Shared starter template configuration and CLAUDE.md memory bank system for Claude Code |
...
| 目前前 5 | ★ | 一句話 |
|---|---|---|
| [Graphify-Labs/graphify](https://github.com/Graphify-Labs/graphify) 🧭 📰 | 114,223 | Turn any codebase, with its docs, SQL schemas, configs, and PDFs, into a queryable knowle… |
| [Egonex-AI/Understand-Anything](https://github.com/Egonex-AI/Understand-Anything) 🧭 📰 | 81,382 | Graphs that teach > graphs that impress. Turn any code into an interactive knowledge grap… |
| [colbymchenry/codegraph](https://github.com/colbymchenry/codegraph) 🧭 📰 | 69,413 | Pre-indexed code knowledge graph, auto syncs on code changes, for Claude Code, Codex, Gem… |
| [abhigyanpatwari/GitNexus](https://github.com/abhigyanpatwari/GitNexus) | 46,949 | GitNexus: The Zero-Server Code Intelligence Engine -       GitNexus is a client-side know… |
| [DeusData/codebase-memory-mcp](https://github.com/DeusData/codebase-memory-mcp) | 42,029 | High-performance code intelligence MCP server. Indexes codebases into a persistent knowle… |
...
| 目前前 5 | ★ | 一句話 |
|---|---|---|
| [github/spec-kit](https://github.com/github/spec-kit) | 133,254 | 💫 Toolkit to help you get started with Spec-Driven Development |
| [Fission-AI/OpenSpec](https://github.com/Fission-AI/OpenSpec) | 67,150 | Spec-driven development (SDD) for AI coding assistants. |
| [gsd-build/get-shit-done](https://github.com/gsd-build/get-shit-done) 📰 | 64,607 | A light-weight and powerful meta-prompting, context engineering and spec-driven developme… |
...
| [buildermethods/agent-os](https://github.com/buildermethods/agent-os) | 5,368 | Agent OS is a system for injecting your codebase standards and writing better specs for s… |
...
| [awslabs/aidlc-workflows](https://github.com/awslabs/aidlc-workflows) | 4,300 | AI-Driven Life Cycle (AI-DLC) adaptive workflow steering rules for AI coding agents |
...
| [gadievron/raptor](https://github.com/gadievron/raptor) | 3,706 | Raptor turns Claude Code into a general-purpose AI offensive/defensive security agent. By… |
| [intellectronica/ruler](https://github.com/intellectronica/ruler) | 2,908 | Ruler — apply the same rules to all coding agents |
...
| 目前前 5 | ★ | 一句話 |
|---|---|---|
| [stablyai/orca](https://github.com/stablyai/orca) | 60,657 | Orca is the ADE for working with a fleet of parallel agents. Run any coding agent with yo… |
| [Yeachan-Heo/oh-my-codex](https://github.com/Yeachan-Heo/oh-my-codex) | 32,973 | OmX - Oh My codeX: Your codex is not alone. Add hooks, agent teams, HUDs, and so much mor… |
| [revfactory/harness](https://github.com/revfactory/harness) | 8,890 | A meta-skill that designs domain-specific agent teams, defines specialized agents, and ge… |
...
| [ZSeven-W/openpencil](https://github.com/ZSeven-W/openpencil) | 5,807 | The world's first open-source AI-native vector design tool and the first to feature concu… |
...
| 目前前 5 | ★ | 一句話 |
|---|---|---|
| [yusufkaraaslan/Skill_Seekers](https://github.com/yusufkaraaslan/Skill_Seekers) | 14,894 | Convert documentation websites, GitHub repositories, and PDFs into Claude AI skills with… |
| [PleasePrompto/notebooklm-mcp](https://github.com/PleasePrompto/notebooklm-mcp) 📰 | 3,392 | MCP server for NotebookLM - Let your AI agents (Claude Code, Codex) research documentatio… |
...
| [trailofbits/claude-code-config](https://github.com/trailofbits/claude-code-config) | 2,099 | Opinionated defaults, documentation, and workflows for Claude Code at Trail of Bits |
| [timescale/pg-aiguide](https://github.com/timescale/pg-aiguide) | 1,833 | MCP server and Claude plugin for Postgres skills and documentation. Helps AI coding tools… |
