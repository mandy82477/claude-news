...
### 2026-07-13
- **[公眾社會運動] 示威者要求 OpenAI、Anthropic、Google DeepMind 暫停 AI 開發**：抗議者在三家公司總部前遊行，要求暫停 AI 開發；報導僅為標題式轉載，未提供遊行規模、具體訴求或後續官方回應等細節（Decrypt，經 Google News 轉載，2026-07-13，待確認細節）
