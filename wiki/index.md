...
| [[topics/community-tech-patterns]] | 🌐 社群 | ongoing | 社群做法盤點 21 類：已定案四類（Multi-agent、Skills、CLAUDE.md、Hooks），另六類活躍、十一類還在試（新增規格驅動開發）　↳ 子故事：[[topics/community-tech-patterns-archive]] |
...
| [[topics/llm-wiki-pattern]] | 🌐 社群 | monitoring | Karpathy 式 LLM wiki 模式：三層＋三動作怎麼設計、外面四種公開實作各自最有辨識度的一招，以及本庫對照下來有什麼、缺什麼 |
