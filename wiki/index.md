...
**最後更新：** 2026-06-10（新增 fable-5；更新 mythos、claude-code、pricing、anthropic-business、ai-agent-safety、community-tech-tools、community-tech-discussions、feature-radar） | **頁面數：** 37
...
| [[entities/fable-5]] | model | active（正式發布）| Claude Fable 5：首款 Mythos 級公開模型，$10/$50 per M token，6/22 前含括訂閱，附安全護欄 |
...
| [[topics/competitor-landscape]]        | monitoring | Google 祕密開發競品 + OpenCode 157K 分流 + DeepSeek clone 低成本替代生態      |
| [[topics/community-tech-tools]]        | ongoing    | 社群工具目錄：189 工具的活躍度、採用狀態追蹤                                       |
| [[topics/community-tech-patterns]]     | monitoring | 社群技術模式：multi-agent、skills 設計、工作流最佳實踐                           |
...
| [[topics/official-community-gap]]      | monitoring | 官方功能 vs 社群痛點缺口矩陣：哪些痛點官方正在解決、哪些結構性缺席                            |
...
| [[topics/community-tech-timeline]]     | monitoring | 社群技術應用趨勢完整時序（2026-04-25 至今），從 community-tech-patterns 拆分                         |
| [[topics/anthropic-business]]          | ongoing    | Anthropic 商業健康度：企業採用率 34.4%、17 倍訂閱補貼、PMF 觀察、Microsoft 退出風險 |
| [[topics/recursive-self-improvement]]  | ongoing    | AI 遞歸自我改進與全球暫停呼籲：Claude 已寫 80-90% Anthropic 程式碼、工程師代碼產出 8×、全球 AI 煞車踏板呼籲 |
