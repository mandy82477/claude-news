...
| [[entities/opus-5-5]] | model | 🤖 模型 | active | Claude Opus 5.5：2026-09-22 發布的現行 Opus，$4/$20（快取讀取 $0.20），官方稱多數工作追平 Fable 5.1；Claude Code v2.1.280 起為 Pro／Max／Team／Enterprise／API 的預設模型 |
