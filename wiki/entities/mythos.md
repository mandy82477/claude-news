...
## 印度政府測試 Mythos（2026-05-27）

印度政府宣布在其網路安全計畫中部署 Mythos 進行安全漏洞測試，是目前有紀錄的首個主權政府採用 Mythos 的案例。測試範圍涵蓋政府系統的 AI 漏洞稽核，符合 Anthropic「優先面向關鍵基礎設施防禦者」的部署原則。（來源：dev.to / CodeGo Group）
