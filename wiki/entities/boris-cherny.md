...
### 2026-05（總結；原始條目已移出）
- 05-05「Loops 是未來」：podcast 宣示已 100% 用 Claude Code 取代手動編碼，提出 Loops（迴圈執行）是 AI 編碼的未來範式
- 05-06「軟體工程已死」：公開宣示 Anthropic 內部已無傳統軟體工程師職位，引發業界廣泛論戰
- 05-08「coding is solved」：Code with Claude 大會宣稱寫程式問題已解決，公開反對「vibe coding」一詞
- 05-13：公開每晚數千個 AI 子代理並行執行「深度工作」的工作流架構，是 Loops 哲學的最極端實踐
- 05-27：Platformer 長篇專訪，為「軟體工程已死」系列論述最完整陳述
- 原始條目見 [[entities/boris-cherny-archive#2026-05]]

### 2026-04（總結；原始條目已移出）
- 04-23：Claude Code 效能退步事件確認後發布事後報告，承諾超過 50 項修復；社群自 05-03 起逐一驗證，逐項結果未見完成，本站已於 2026-09-07 停止追蹤
- 04-25：The Verge 報導中聲明訂閱方案並非為第三方 agentic 工具使用模式而設計
- 原始條目見 [[entities/boris-cherny-archive#2026-04]]
