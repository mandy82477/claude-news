...
**Meta 正式發布「Muse Code」加入 Claude Code／Codex 編碼 agent 競爭賽道**：WSJ／CNET／Basic Tutorials（08-05～08-07）三方媒體報導，07-09 已追蹤的「Meta AI 程式輔助工具」傳聞正式落地為具名產品；同期 the-decoder.com 稱 Claude Code 速度最快但成本近最便宜對手三倍——**2026-08-10 查證原文確認**：Composio 以 DeepSeek V4 Flash 為模型、30 個真實任務測 Claude Code／Codex／OpenCode／Oh My Pi 四框架，Claude Code 每成功任務 $0.195、OpenCode（最便宜）僅 $0.073，實際倍數 2.67 倍（2026-08-06 發布）。詳見 [[topics/competitor-landscape]]。
...
**Dario Amodei 公開澄清開源權重立場、呼籲加強晶片出口管制，延續「反對全面禁令、卻支持限縮關鍵能力」立場矛盾**：部落格聲明「Our position on open-weights models」（HN 972 分）澄清 Anthropic 從未主張全面禁止開源權重模型，但籲加強對中國晶片出口管制；OpenAI／Anthropic 員工聯名致信美國政府討論 AI 發展步調控管；書籍銷毀爭議新增細節——The Guardian（08-05）引述法院文件揭露內部代號「Project Panama」的破壞性書籍掃描計畫——**2026-08-10 查證確認與 $1.5B 和解案同源**：Project Panama 的內部規劃文件正是在 *Bartz v. Anthropic* 著作權集體訴訟（即 2025 年 $1.5B 和解案的同一訴訟）的法庭文件解封過程中曝光，兩者屬同一案件的不同揭露階段，非各自獨立事件。詳見 [[topics/anthropic-government-policy]]。
...
3. **[[topics/competitor-landscape]] — Meta Muse Code 正式對標 Claude Code／Codex**（monitoring）
   - 07-09 傳聞正式落地為具名產品；Claude Code 速度最快但成本近最便宜對手三倍（2026-08-10 查證：Composio 30 任務實測 2.67 倍，$0.195 vs OpenCode $0.073）；Qwen 3.8／Kimi K3 效果相當而成本三分之一

4. **[[topics/anthropic-government-policy]] — 出口管制主線已解除，剩餘支線持續**
   - Dario 澄清「非反開源」但籲加強晶片管制；書籍銷毀爭議新增「Project Panama」內部代號細節（2026-08-10 查證：與 $1.5B 和解案同源，均出自 *Bartz v. Anthropic* 訴訟）；「反對全面禁令、卻支持限縮關鍵能力」立場矛盾持續
...
- **法律**：$1.5B 著作權和解案執行穩定推進（91% 申請率、律師費 6.8%）；「Project Panama」書籍破壞性掃描細節新增，2026-08-10 查證確認與和解案同源（同屬 *Bartz v. Anthropic* 訴訟）；專利侵權、田納西大學提告兩起獨立訴訟持續觀察
