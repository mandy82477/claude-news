...
### community-tech-patterns ↔ community-tech-discussions 雙向連結規則
...
### community-tech-discussions 技術彙整書寫規則
...
### 警示觸發重構（超過閾值時，本次 ingest 嘗試修復；若工作量過大，記錄至 log.md 待辦）
