...
欄位語意（`.claude/reporter-rules/shared.md`）：「最後新聞更新」填**日報日期**，
...
DERIVED_PAGES = {
    ...
    "topics/community-pattern-trends":
        ".claude/reporter-rules/community/weekly.md（週更，讀 patterns 頁）",
    "topics/community-large-codebase-workflow":
        ".claude/reporter-rules/community/weekly.md 週更整線重寫（吃 patterns 頁"
        "帶 `**主線：**` tag 的節點；每日 ingest 只標 tag、不寫此頁）",
    "topics/official-community-gap":
        ".claude/reporter-rules/features/daily.md 產品化矩陣同步",
    "topics/anthropic-commitments":
        ".claude/skills/wiki-ingest/references/classification.md 第三步（主編彙整）",
    "topics/model-task-leaderboard":
        ".claude/reporter-rules/models/daily.md 例外條（吃外部榜單網站，"
        "由 /wiki-lint 步驟 5b 抓取；每日 ingest 不更新）",
    "topics/engineering-skill-playbook":
        ".claude/reporter-rules/features/daily.md「工程流程 Skill 指南維護」"
