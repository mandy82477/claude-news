...
# `.claude/reporter-rules/shared.md`「維運備忘的家」。非貪婪，且不跨越
...
# `.claude/reporter-rules/market/daily.md`「判讀格式（機械契約字串）」表，兩端互相指認
...
# 欄名若改動，`.claude/skills/weekly-report/references/forecast.md` 第 (3) 段的欄位定義必須同步（見 review-registry sync_pair）。
