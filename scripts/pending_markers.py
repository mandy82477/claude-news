...
語法規格見 `.claude/reporter-rules/page-templates.md`「懸置標記語法」節。**規格與本檔
...
# ── 語法 regex（與 .claude/reporter-rules/page-templates.md 規格逐字對應）────────────────────
...
#   status_format  人物頁 `active（待核實）`——`.claude/reporter-rules/people/daily.md`
