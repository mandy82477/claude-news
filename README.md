...
wiki 的頁不是一疊各寫各的文章，彼此用 wikilink 牽著。網站「地圖」分頁把這張網重畫了一次，可以搜尋、篩選，點一個節點就在側欄開那頁——不必裝 Obsidian。

89 個節點、615 條連結，但不是每條都一樣重。頁尾「相關實體」「延伸閱讀」那種樣板區，連結補得最勤，全畫出來只會糊成一團毛球。所以地圖預設只畫正文裡真的寫下的那 497 條，想看全貌再把樣板連結打開。

節點還帶著領域色和「幾天沒更新了」，掃一眼就知道哪一塊還在長、哪一塊冷掉了。
