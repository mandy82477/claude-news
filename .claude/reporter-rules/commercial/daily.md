...
>
> **唯一例外：`wiki/topics/market-signals.md`** `[加入: 2026-09-05]`——該頁領域雖為 💼 商業，但由**投資分析記者**維護（`.claude/reporter-rules/market/daily.md`），你不寫該頁的判讀內容；懸置掃描把該頁的標記派給你時，照共用規則只加 `訊`。它是觀點層，事實層仍在你的頁面上，兩者以 wikilink 相連。
