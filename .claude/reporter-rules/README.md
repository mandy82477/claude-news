...
- **主編**：由 `.claude/skills/wiki-ingest/SKILL.md`、`wiki-lint.md`、`wiki-backfill.md` 等 command／skill 內文指名（`wiki-ingest.md` 為主編指南，`*-lint.md` 為週更專用，`wiki-lint-inquiry.md`／`wiki-lint-adversarial.md` 為 lint 特定步驟）
