...
description: Wiki 人物記者：負責 wiki/index.md 領域欄為 👤 人物 的所有頁面（動態認領，清單見其規則檔）。任何涉及人物主題的 wiki 任務都呼叫此 agent。
...
2. `.claude/reporter-rules/people/daily.md` — 負責頁面清單與人物更新規則
3. 需建立新頁面時，另讀 `.claude/reporter-rules/page-templates.md`
