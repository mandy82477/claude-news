...
**出口管制已解除，封鎖 18 天**（2026-06-12 商務部管制生效 → 06-30 商務部通知 Anthropic 管制已移除；Anthropic 同晚公告，07-01 全球恢復存取）。**天數以「管制生效日 → 解除通知日」計；把首尾兩天都算進去是 19 天，MarketScale 07-03 報的就是這個算法。** Anthropic 以三項義務換取解封：主動偵測安全風險、與政府合作制定標準、通報惡意活動。談判由共同創辦人 Tom Brown 於 06-25 接管後完成。
